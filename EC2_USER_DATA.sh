...
aws s3 cp s3://ia.ws/AWSExperiment.jar /opt/spring-boot-ec2-demo/ --region=us-east-1

# create a springboot user to run the app as a service
useradd springboot
# springboot login shell disabled
chsh -s /sbin/nologin springboot
chown springboot:springboot /opt/spring-boot-ec2-demo/AWSExperiment.jar
chmod 500 /opt/spring-boot-ec2-demo/AWSExperiment.jar

# create a symbolic link
ln -s /opt/spring-boot-ec2-demo/AWSExperiment.jar /etc/init.d/spring-boot-ec2-demo
